...
# Bot information
API_ID = environ.get('API_ID', '19341831')
if len(API_ID) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '1076927614 1086049246 951469747')
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002160880207').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002193397974')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002177384458')
...
SHORTLINK_API = environ.get("SHORTLINK_API", "b661ad0a2d94a6234a8e5d924e6d11abccb97bcb")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002151964482")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://quaint-alison-akvcontact-20488a81.koyeb.app/")
if len(URL) == 0:
